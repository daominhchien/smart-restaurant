...
//    MODIFIER_NOT_VALID_FOR_ITEM("1038", "MODIFIER_NOT_VALID_FOR_ITEM", HttpStatus.BAD_REQUEST),
    ...
    ORDER_NOT_STATUS_PENDING("1065", "Order chưa yêu cầu thanh toan", HttpStatus.BAD_REQUEST),
    TYPE_MOMO_NOT_FOUND("1066", "TypePayment MOMO not found", HttpStatus.BAD_REQUEST);
